...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin_assets/vendor/jquery-nice-select/css/nice-select.css')}}">

 <link rel="stylesheet" type="text/css" href="{{asset('admin_assets/vendor/owl-carousel/owl.carousel.css')}}">


 <link rel="stylesheet" type="text/css" href="{{asset('admin_assets/vendor/nouislider/nouislider.min.css')}}">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="form-element.html">Add Sub Category</a></li>
                            <li><a href="form-wizard.html">All Sub Category</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="page-login.html">Add Product</a></li>
                            <li><a href="page-register.html">All Products</a></li>
                            <
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="page-login.html">Latest Orders</a></li>
                            <li><a href="page-register.html">Completed Orders</a></li>
                            <li><a href="page-register.html">Pending Orders</a></li>
                            <li><a href="page-register.html">Cancel Orders</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="page-login.html">Add User</a></li>
                            <li><a href="page-register.html">All Users</a></li>
                            <
...
@yield("admin")
 ...
 <script type="text/javascript" src="{{asset('admin_assets/vendor/global/global.min.js')}}"></script>

 <script type="text/javascript" src="{{asset('admin_assets/vendor/chart.js/Chart.bundle.min.js')}}"></script>


 <script type="text/javascript" src="{{asset('admin_assets/vendor/jquery-nice-select/js/jquery.nice-select.min.js')}}"></script>
   
<script type="text/javascript" src="{{asset('admin_assets/vendor/apexchart/apexchart.js')}}"></script>

<script type="text/javascript" src="{{asset('admin_assets/vendor/chart.js/Chart.bundle.min.js')}}"></script>


<script type="text/javascript" src="{{asset('admin_assets/vendor/peity/jquery.peity.min.js')}}"></script>

<script type="text/javascript" src="{{asset('admin_assets/js/dashboard/dashboard-1.js')}}"></script>




<script type="text/javascript" src="{{asset('admin_assets/vendor/owl-carousel/owl.carousel.js')}}"></script>


<script type="text/javascript" src="{{asset('admin_assets/js/custom.min.js')}}"></script>


<script type="text/javascript" src="{{asset('admin_assets/js/dlabnav-init.js')}}"></script>

<script type="text/javascript" src="{{asset('admin_assets/js/demo.js')}}"></script>


<script type="text/javascript" src="{{asset('admin_assets/js/styleSwitcher.js')}}"></script>
